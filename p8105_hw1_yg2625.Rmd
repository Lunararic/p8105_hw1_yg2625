...
The size of the dataset is `r nrow(Prob2_df)`, the mean of x is `r mean(Prob2_df$x)`, the median of x is `r median(Prob2_df$x)`, and the proportion of cases for which the logical vector is TRUE is `r table(Prob2_df$vec_logical)["TRUE"]/nrow(Prob2_df)`.
...
```
From the scatterplot, we could see almost 50% of the logcial variables datapoints lie as True and 50% lie as False. The real proportion of True and False could be calculated by R.
...
```
From the scatterplot, we could see almost 50% of the numerical variables datapoints lie as True and 50% lie as False. The real proportion of True and False could be calculated by R.
...
```
From the scatterplot, we could see almost 50% of the factor variables datapoints lie as True and 50% lie as False. The real proportion of True and False could be calculated by R.
